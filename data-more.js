const buildMoreStyle = (entry) => ({
  ...
  genes: {
    composition: [entry.prompt[1][0]],
    form: [entry.prompt[2][0]],
    color: [entry.prompt[3][0]],
    type: [entry.prompt[4][0]],
    texture: [entry.prompt[5][0]]
  },
...
const MORE_STYLE_DATA = [
  ...
  buildMoreStyle({
    ...
    prompt: [["低眉艺术与波普超现实主义", "Lowbrow art and Pop Surrealism"], ["中心角色与怪诞叙事构图", "centered character with uncanny narrative composition"], ["复古卡通与大眼怪诞角色", "retro cartoons and big-eyed uncanny characters"], ["糖果色配暗色阴影", "candy colors with dark shadows"], ["复古招牌式标题", "retro sign-painting display type"], ["光滑细描与旧广告印刷", "smooth detailed painting and vintage ad-print texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["工笔画视觉语言", "Gongbi painting visual language"], ["平稳留白构图", "balanced composition with reserved space"], ["精谨线描与细密花鸟", "precise outlines and finely observed flora and fauna"], ["矿物青绿与朱砂设色", "mineral blue-green and cinnabar palette"], ["细雅题跋", "refined calligraphic inscription"], ["绢本层染质感", "layered pigment on silk texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["敦煌壁画视觉语言", "Dunhuang mural visual language"], ["藻井中心与连续叙事构图", "caisson-centered continuous narrative composition"], ["飞天飘带与佛教图像", "flying apsaras ribbons and Buddhist imagery"], ["赭红石绿与土金", "ochre red mineral green and earthy gold"], ["写经式题记", "sutra-like inscription"], ["风化矿物壁画质感", "weathered mineral fresco texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["中国木版年画", "Chinese woodblock New Year print"], ["正面对称满版构图", "frontal symmetrical full composition"], ["吉祥人物与民间纹样", "auspicious figures and folk motifs"], ["朱红明黄与石绿套色", "vermilion yellow and mineral green palette"], ["手刻榜书标题", "hand-carved display lettering"], ["木版套色与纸张纤维", "registered woodblock ink and fibrous paper"]]
  }),
  buildMoreStyle({
  ...
  buildMoreStyle({
    ...
    prompt: [["琳派装饰艺术", "Rinpa decorative art"], ["大胆留白与边缘裁切", "bold negative space and edge cropping"], ["花鸟流水平面造型", "flat flowers birds and flowing water forms"], ["金地群青与朱红", "gold ground ultramarine and vermilion"], ["雅致题签", "elegant calligraphic title"], ["金箔绢本与矿物颜料", "gold leaf silk and mineral pigment texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["日本画美学", "Nihonga aesthetic"], ["安静平衡与浅层空间", "quiet balance and shallow pictorial space"], ["细腻自然形态与清晰轮廓", "delicate natural forms with clear contours"], ["柔和矿物色与灰绿色", "soft mineral pigments and gray-green palette"], ["极简日文题签", "minimal Japanese inscription"], ["岩彩和纸哑光质感", "matte mineral pigment on washi texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["侘寂美学", "wabi-sabi aesthetic"], ["不对称留白构图", "asymmetrical composition with generous negative space"], ["朴素不规则形态", "humble irregular forms"], ["灰褐土色低饱和", "muted gray-brown earth tones"], ["极少文字", "minimal understated typography"], ["风化陶土木材与裂纹", "weathered clay wood and cracked texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["卡哇伊角色美学", "kawaii character aesthetic"], ["中心角色与小型装饰环绕", "centered character with tiny surrounding motifs"], ["幼态比例与圆润轮廓", "chibi proportions and rounded contours"], ["粉彩糖果色", "pastel candy-color palette"], ["圆润友好标题字", "rounded friendly display type"], ["光滑贴纸与柔软塑料质感", "smooth sticker and soft plastic texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["超扁平视觉语言", "Superflat visual language"], ["高密度无纵深满版构图", "dense all-over composition without depth"], ["卡通角色与重复符号", "cartoon characters and repeated symbols"], ["明亮高饱和商业色", "bright saturated commercial palette"], ["动画式粗体标题", "anime-inspired bold display type"], ["无阴影光滑印刷表面", "shadowless smooth printed surface"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["韩国民画", "Korean Minhwa folk painting"], ["平面散点叙事构图", "flat scattered narrative composition"], ["虎鹊书架与吉祥符号", "tiger magpie bookshelves and auspicious symbols"], ["朱红群青与明黄", "vermilion cobalt and bright yellow"], ["民间手写题字", "folk hand-lettered inscription"], ["矿物颜料韩纸质感", "mineral pigment on hanji paper texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["波斯细密画", "Persian miniature painting"], ["多层俯视与装饰边框", "layered elevated view with ornamental border"], ["精微宫廷人物与花园", "finely drawn court figures and gardens"], ["群青朱红与金色", "ultramarine vermilion and gold"], ["波斯书法题记", "Persian calligraphic inscription"], ["金粉矿物颜料纸本", "gold and mineral pigment on paper"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["米提拉民间绘画", "Madhubani folk painting"], ["无留白满版构图", "dense all-over composition without empty space"], ["双线人物与动植物纹样", "double-line figures and flora-fauna motifs"], ["天然红黄绿黑", "natural red yellow green and black palette"], ["手绘符号边框", "hand-drawn symbolic border"], ["粗纤维纸与天然颜料", "coarse paper and natural pigment texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["藏传唐卡绘画", "Tibetan Thangka painting"], ["严格中心层级对称", "strict centered hierarchical symmetry"], ["神祇莲座光环与云纹", "deity lotus throne halo and cloud motifs"], ["朱红群青石绿与金色", "vermilion ultramarine mineral green and gold"], ["仪轨题记", "ritual inscription"], ["矿物颜料金线与织锦", "mineral pigment gold line and brocade texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["墨西哥壁画运动视觉", "Mexican Muralism visual language"], ["宏大对角群像构图", "monumental diagonal group composition"], ["劳动人物与社会叙事", "workers and social narrative"], ["土红深蓝与赭黄", "earth red deep blue and ochre"], ["公共标语式标题", "public slogan-like lettering"], ["湿壁画与粗灰泥质感", "fresco and rough plaster texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["墨西哥民间艺术", "Mexican folk art"], ["中心对称装饰构图", "centered symmetrical ornamental composition"], ["花卉动物与节庆符号", "flowers animals and festival symbols"], ["亮红青绿与金黄", "bright red turquoise and golden yellow"], ["手绘节庆标题", "hand-painted festive lettering"], ["彩绘木雕与陶器质感", "painted woodcarving and ceramic texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["非洲蜡染印花视觉", "African wax print aesthetic"], ["连续满版重复构图", "continuous all-over repeat composition"], ["几何植物与象征图案", "geometric botanical and symbolic motifs"], ["橙黄钴蓝与洋红", "orange yellow cobalt and magenta"], ["粗体织物标签字", "bold textile-label typography"], ["蜡防染裂纹与棉布", "wax-resist crackle and cotton texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["非洲未来主义", "Afrofuturism"], ["英雄式中心人物构图", "heroic centered character composition"], ["未来服饰与非洲纹样", "futuristic attire with African motifs"], ["紫色金色与绿松石", "violet gold and turquoise palette"], ["几何未来标题", "geometric futuristic typography"], ["金属珠饰织物与宇宙光泽", "metal beadwork textiles and cosmic sheen"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["斯堪的纳维亚现代主义", "Scandinavian Modern design"], ["开放平衡与充足留白", "open balanced composition with ample space"], ["柔和有机功能形态", "soft organic functional forms"], ["浅木色灰绿与柔白", "light wood gray-green and soft white"], ["人文无衬线字体", "humanist sans-serif typography"], ["浅色木材羊毛与陶瓷", "light wood wool and ceramic texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["流线型现代主义", "Streamline Moderne"], ["水平延展与速度线构图", "horizontal composition with speed lines"], ["圆角流线和空气动力形态", "rounded aerodynamic forms"], ["象牙白海蓝与镀铬银", "ivory ocean blue and chrome silver"], ["细长几何标题字", "elongated geometric display type"], ["搪瓷镀铬与光滑玻璃", "enamel chrome and smooth glass texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["原子时代设计", "Atomic Age design"], ["不对称漂浮图形构图", "asymmetrical floating graphic composition"], ["星爆轨道与回旋镖形", "starbursts orbit lines and boomerang shapes"], ["芥末黄青绿与砖橙", "mustard teal and brick orange"], ["复古几何展示字", "retro geometric display type"], ["平版印刷与层压板质感", "lithographic print and laminate texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["新浪潮字体设计", "New Wave Typography"], ["断裂网格与多重阅读路径", "broken grid with multiple reading paths"], ["旋转文字与尺度跳跃", "rotated type and abrupt scale shifts"], ["黑白配红蓝高对比", "black and white with red-blue contrast"], ["实验无衬线混排", "experimental mixed sans-serif typography"], ["错位叠印与纸张颗粒", "misregistered overprint and paper grain"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["朋克 DIY 视觉", "punk DIY visual style"], ["反网格剪贴构图", "anti-grid cut-and-paste composition"], ["撕纸照片与手绘符号", "torn photos and hand-drawn marks"], ["黑白与单一猩红", "black and white with a single scarlet accent"], ["剪报字与粗暴手写", "ransom-note type and raw handwriting"], ["复印噪点胶带与折痕", "photocopy noise tape and fold marks"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["九十年代垃圾摇滚设计", "1990s grunge design"], ["不稳定叠层与越界构图", "unstable layered composition with bleeding edges"], ["低清照片与侵蚀图形", "lo-fi photography and distressed graphics"], ["脏灰土褐与暗红", "dirty gray earth brown and dark red"], ["磨损粗体与打字机字", "distressed bold type and typewriter text"], ["划痕污渍与复印颗粒", "scratches stains and photocopy grain"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["拟物化数字设计", "skeuomorphic digital design"], ["实体控制面板式布局", "physical control-panel layout"], ["立体按钮旋钮与真实图标", "dimensional buttons knobs and realistic icons"], ["自然材质色与金属强调", "natural material colors with metallic accents"], ["清晰界面标签", "clear interface labeling"], ["皮革木纹金属与缝线", "leather wood metal and stitched texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["玻璃拟态视觉", "glassmorphism visual style"], ["半透明面板分层构图", "layered translucent panel composition"], ["圆角玻璃模块与悬浮界面", "rounded glass modules and floating interface"], ["冷蓝淡紫与柔白", "cool blue pale violet and soft white"], ["轻量无衬线界面字", "lightweight sans-serif interface type"], ["磨砂玻璃背景模糊与亮边", "frosted glass backdrop blur and luminous edges"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["新拟态界面", "neumorphic interface"], ["规则模块与充足间距", "regular modules with generous spacing"], ["同色凸起和内凹控件", "same-color raised and inset controls"], ["柔灰蓝低对比配色", "soft gray-blue low-contrast palette"], ["克制现代无衬线", "restrained modern sans-serif"], ["哑光表面与双向柔影", "matte surface with dual soft shadows"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["酸性视觉设计", "acid graphics"], ["密集越界与中心爆发构图", "dense edge-bleeding composition with central burst"], ["液态金属和尖锐变形图形", "liquid metal and sharp distorted forms"], ["酸绿电紫与深黑", "acid green electric violet and black"], ["极端压缩实验字体", "extreme condensed experimental typography"], ["镀铬辉光与数字噪点", "chrome glow and digital noise"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["蒸汽朋克视觉语言", "steampunk visual language"], ["机械结构层叠与深景构图", "layered mechanical structure with deep spatial composition"], ["黄铜齿轮管线与维多利亚服饰", "brass gears pipes and Victorian attire"], ["铜棕煤黑与暗青", "copper brown coal black and dark teal"], ["维多利亚衬线与机械铭牌", "Victorian serif and engraved machine labels"], ["黄铜皮革木材与煤烟", "brass leather wood and soot texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["复古未来主义", "retrofuturism"], ["开阔地平线与英雄机器构图", "open horizon with heroic machine composition"], ["流线飞船圆顶与复古宇航服", "streamlined spacecraft domes and retro spacesuits"], ["暖黄青绿与珊瑚红", "warm yellow teal and coral red"], ["太空时代展示字体", "Space Age display typography"], ["喷漆金属与旧杂志印刷", "painted metal and vintage magazine print texture"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["日系动画视觉语言", "Japanese anime visual language"], ["电影分镜式动态构图", "cinematic storyboard-like dynamic composition"], ["清晰线稿与平涂角色", "clean linework and cel-shaded characters"], ["明快主色与环境色", "bright key colors with atmospheric hues"], ["简洁动画标题字", "clean anime title typography"], ["赛璐璐阴影与细腻背景", "cel shading with detailed painted background"]]
  }),
  buildMoreStyle({
  ...
  buildMoreStyle({
    ...
    prompt: [["美式漫画视觉语言", "American comic-book art"], ["动态分格与极端透视", "dynamic panels with extreme perspective"], ["英雄人物与粗黑墨线", "heroic figures with heavy black inks"], ["红黄蓝原色高对比", "high-contrast red yellow and blue primaries"], ["爆炸拟声字和粗体标题", "explosive sound effects and bold display type"], ["半调网点与旧漫画纸", "halftone dots and vintage comic paper"]]
  }),
  buildMoreStyle({
  ...
  buildMoreStyle({
    ...
    prompt: [["暗黑奇幻视觉语言", "dark fantasy visual language"], ["巨大环境压缩微小人物", "monumental environment dwarfing small figures"], ["废墟怪物与扭曲自然", "ruins creatures and distorted nature"], ["冷灰暗紫与旧金", "cold gray dark violet and aged gold"], ["古老尖锐衬线标题", "ancient sharp serif title"], ["风化石材盔甲与烟雾", "weathered stone armor and smoke texture"]]
  }),
  buildMoreStyle({
  ...
  buildMoreStyle({
    ...
    prompt: [["田园核美学", "cottagecore aesthetic"], ["亲密自然场景与柔和留白", "intimate natural scene with soft breathing space"], ["野花木屋亚麻与手作物", "wildflowers cottage linen and handmade objects"], ["鼠尾草绿柔粉与奶白", "sage green dusty pink and creamy white"], ["温柔手写与古典衬线", "gentle script and classic serif type"], ["亚麻木材纸张与柔光颗粒", "linen wood paper and soft-light grain"]]
  }),
  buildMoreStyle({
    ...
    prompt: [["暗黑学院美学", "Dark Academia aesthetic"], ["旧图书馆纵深与静态构图", "deep old-library setting with static composition"], ["旧书制服雕塑与烛台", "old books uniforms sculpture and candlesticks"], ["深棕墨绿与羊皮纸色", "deep brown forest green and parchment"], ["古典高对比衬线体", "classical high-contrast serif type"], ["深色木材呢料纸张与灰尘", "dark wood tweed paper and dust texture"]]
  }),
  buildMoreStyle({
  ...
  buildMoreStyle({
    ...
    prompt: [["阈限空间美学", "liminal space aesthetic"], ["空旷重复透视构图", "empty repetitive perspective composition"], ["无人走廊门窗与过渡空间", "deserted corridors doorways and transitional spaces"], ["褪色黄绿与冷灰", "faded yellow-green and cool gray"], ["稀少功能标识", "sparse functional signage"], ["荧光灯噪点旧地毯与塑料", "fluorescent noise worn carpet and plastic texture"]]
  })
];
