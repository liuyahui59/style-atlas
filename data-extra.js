const buildStyle = (entry) => {
  const { visualSpec: _visualSpec, ...style } = entry;
  return {
    ...style,
...
const EXTRA_STYLE_DATA = [
  buildStyle({
    ...
    visualSpec: [["古埃及壁画语境", "ancient Egyptian mural language"], ["横向分层构图", "horizontal register composition"], ["正侧面复合人物", "composite-profile figures"], ["象形文字边饰", "hieroglyphic borders"], ["赭金与孔雀蓝", "ochre gold and peacock blue"], ["矿物颜料石壁质感", "mineral pigment on stone texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["古希腊古典美学", "Classical Greek aesthetic"], ["均衡中心构图", "balanced centered composition"], ["理想化人体比例", "idealized human proportion"], ["多立克柱式秩序", "Doric architectural order"], ["大理石白与陶土红", "marble white and terracotta red"], ["雕刻石材质感", "carved stone texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["古罗马壁画语境", "ancient Roman fresco context"], ["轴线式空间", "axial spatial composition"], ["拱券与写实人物", "arches and realistic figures"], ["庞贝红主色", "Pompeian red palette"], ["碑铭式文字", "Roman inscription lettering"], ["湿壁画与马赛克质感", "fresco and mosaic texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["拜占庭圣像艺术", "Byzantine icon art"], ["庄严正面对称", "solemn frontal symmetry"], ["细长轮廓人物", "elongated outlined figures"], ["金色非现实背景", "otherworldly gold background"], ["群青与紫红", "ultramarine and imperial purple"], ["玻璃马赛克金箔质感", "glass mosaic and gold leaf texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["哥特式视觉语言", "Gothic visual language"], ["高耸垂直构图", "soaring vertical composition"], ["尖拱与玫瑰窗", "pointed arches and rose window"], ["宝石蓝深红光线", "jewel-blue and crimson light"], ["装饰手抄文字", "illuminated manuscript lettering"], ["彩色玻璃与石雕质感", "stained glass and carved stone texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["莫卧儿细密画", "Mughal miniature painting"], ["多层俯视叙事", "layered bird's-eye narrative"], ["精微人物与花卉边框", "finely drawn figures and floral border"], ["孔雀蓝朱红与金色", "peacock blue vermilion and gold"], ["波斯书法题记", "Persian calligraphic inscription"], ["矿物颜料金粉纸本", "mineral pigment and gold on paper"]]
  }),
  buildStyle({
    ...
    visualSpec: [["西非传统雕刻语言", "West African sculptural language"], ["正面垂直构图", "frontal vertical composition"], ["几何化面具轮廓", "geometric mask-like forms"], ["炭黑木棕与白土", "charcoal black wood brown and kaolin white"], ["象征刻纹", "symbolic incised pattern"], ["手凿木材与纤维质感", "hand-carved wood and fiber texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["矫饰主义绘画", "Mannerist painting"], ["不稳定偏心构图", "unstable off-center composition"], ["拉长人体与蛇形姿态", "elongated figures and serpentine poses"], ["冷粉酸绿银蓝", "cool pink acid green and silver blue"], ["宫廷式精致", "courtly refinement"], ["光滑油画薄涂", "smooth glazed oil texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["洛可可装饰美学", "Rococo decorative aesthetic"], ["轻盈非对称构图", "light asymmetrical composition"], ["贝壳曲线与花叶纹", "rocaille curves and floral scrolls"], ["粉蓝粉红浅金", "powder blue blush pink and pale gold"], ["优雅花体标题", "elegant flourished lettering"], ["丝绸瓷器与镀金质感", "silk porcelain and gilded texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["新古典主义语境", "Neoclassical visual language"], ["稳定轴线构图", "stable axial composition"], ["雕塑般人物与柱式", "sculptural figures and classical columns"], ["石灰白庞贝红", "limestone white and Pompeian red"], ["碑铭式衬线字体", "inscriptional serif typography"], ["抛光大理石与平滑油彩", "polished marble and smooth oil finish"]]
  }),
  buildStyle({
    ...
    visualSpec: [["浪漫主义崇高感", "Romantic sublime"], ["人物与自然尺度反差", "dramatic human-to-nature scale contrast"], ["风暴般对角运动", "storm-driven diagonal movement"], ["深蓝灰与夕阳金", "deep blue-gray and sunset gold"], ["文学性叙事", "literary narrative mood"], ["透明油彩与大气雾感", "glazed oil paint and atmospheric haze"]]
  }),
  buildStyle({
    ...
    visualSpec: [["现实主义绘画", "Realist painting"], ["平视现场构图", "eye-level observational composition"], ["未经美化的普通人物", "unidealized everyday figures"], ["土褐灰绿低饱和", "earth brown and gray-green palette"], ["社会纪实语气", "social documentary tone"], ["厚实油彩与粗糙材质", "substantial oil paint and rough material texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["前拉斐尔派绘画", "Pre-Raphaelite painting"], ["近景植物包围构图", "close botanical enclosure"], ["精密人物与中世纪服饰", "finely rendered figures in medieval dress"], ["翡翠朱红群青", "emerald vermilion and ultramarine"], ["文学象征细节", "literary symbolic detail"], ["湿白底油画与织物质感", "luminous wet-ground oil and textile texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["工艺美术运动图案", "Arts and Crafts pattern design"], ["对称满版重复", "symmetrical all-over repeat"], ["扁平花叶与藤蔓", "flat botanical leaves and vines"], ["靛蓝茜红橄榄绿", "indigo madder red and olive green"], ["手工中世纪字体", "hand-crafted medieval lettering"], ["木版印刷与织物质感", "woodblock print and woven textile texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["后印象主义绘画", "Post-Impressionist painting"], ["主观节奏构图", "subjective rhythmic composition"], ["强化轮廓与旋转笔触", "bold contours and swirling brushwork"], ["钴蓝铬黄橙红", "cobalt blue chrome yellow and orange-red"], ["情绪化空间", "emotionally charged space"], ["厚涂油彩肌理", "visible impasto oil texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["象征主义梦境", "Symbolist dream imagery"], ["仪式化中心构图", "ritualized centered composition"], ["神话人物与隐喻物件", "mythic figures and allegorical objects"], ["暗金夜蓝灰紫", "antique gold night blue and gray violet"], ["文学与神秘学气质", "literary occult atmosphere"], ["金箔与柔雾油彩", "gold leaf and hazy oil texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["野兽派绘画", "Fauvist painting"], ["扁平近景色域", "flat close-cropped color fields"], ["简化轮廓与宽阔笔触", "simplified contours and broad brushwork"], ["朱红钴蓝翠绿强撞", "vermilion cobalt and emerald clash"], ["非自然主观色彩", "non-natural subjective color"], ["直接油彩画布肌理", "direct oil-on-canvas texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["表现主义绘画", "Expressionist painting"], ["倾斜压迫构图", "tilted claustrophobic composition"], ["扭曲人物与尖锐轮廓", "distorted figures and jagged contours"], ["酸黄血红深蓝", "acid yellow blood red and deep blue"], ["强烈心理张力", "intense psychological tension"], ["木刻与干涩厚涂质感", "woodcut marks and dry impasto texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["分析立体主义", "Analytical Cubism"], ["中心切面互锁构图", "central interlocking faceted composition"], ["多视点几何碎片", "multi-view geometric fragments"], ["赭石灰褐墨黑", "ochre gray-brown and black"], ["报纸字母拼贴", "newspaper letter collage"], ["纸张木纹与沙粒油彩", "paper woodgrain and gritty oil texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["意大利未来主义", "Italian Futurism"], ["放射对角线构图", "radiating diagonal composition"], ["机械切面与速度残影", "mechanical facets and motion trails"], ["钢灰电蓝橙红", "steel gray electric blue and orange-red"], ["斜体爆发式排版", "italic explosive typography"], ["金属与粗颗粒印刷", "metallic and coarse print texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["达达主义拼贴", "Dada photomontage"], ["故意失序反网格", "deliberately disordered anti-grid"], ["剪报照片与现成物", "newspaper cutouts and found objects"], ["黑白灰配单一红", "black white gray with one red accent"], ["混合字号旋转排版", "mixed-scale rotated typography"], ["撕纸胶痕旧报质感", "torn paper glue marks and aged newsprint"]]
  }),
  buildStyle({
    ...
    visualSpec: [["至上主义抽象", "Suprematist abstraction"], ["无限白场非对称平衡", "asymmetric balance in an infinite white field"], ["漂浮方圆十字", "floating squares circles and crosses"], ["黑白红有限原色", "black white red limited primaries"], ["几乎无文字", "near-absence of typography"], ["平涂油彩画布细纹", "flat oil paint on subtly textured canvas"]]
  }),
  buildStyle({
    ...
    visualSpec: [["风格派设计语言", "De Stijl design language"], ["非对称正交网格", "asymmetric orthogonal grid"], ["矩形与水平垂直线", "rectangles with horizontal and vertical lines"], ["红黄蓝黑白", "red yellow blue black and white"], ["几何无衬线排版", "geometric sans-serif typography"], ["纯净平涂漆面", "clean flat painted finish"]]
  }),
  buildStyle({
    ...
    visualSpec: [["装饰艺术视觉", "Art Deco visual language"], ["高耸轴线对称", "soaring axial symmetry"], ["阶梯轮廓与放射日芒", "stepped silhouettes and sunburst motifs"], ["黑金与翡翠绿", "black gold and emerald green"], ["细长几何大写字", "elongated geometric capitals"], ["黄铜大理石与漆面质感", "brass marble and lacquer texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["抽象表现主义", "Abstract Expressionism"], ["满幅无中心构图", "all-over non-hierarchical composition"], ["滴洒线网与挥扫笔触", "dripped linework and sweeping gestures"], ["黑白土色配强烈色块", "black white earth tones with forceful accents"], ["身体性动作痕迹", "physical traces of action"], ["流淌厚涂与裸画布", "flowing impasto and exposed canvas texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["色域绘画", "Color Field painting"], ["大尺度平静色域", "large meditative color fields"], ["柔边矩形与染色层", "soft-edged rectangles and stained layers"], ["深红橙黄与靛蓝", "deep red orange-yellow and indigo"], ["极少视觉层级", "minimal visual hierarchy"], ["薄染哑光画布质感", "stained matte canvas texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["欧普艺术", "Op Art"], ["满版同心重复", "all-over concentric repetition"], ["波形黑白条纹", "warped black-and-white stripes"], ["极端黑白高反差", "extreme black-and-white contrast"], ["精确几何秩序", "precise geometric order"], ["硬边丝网印刷质感", "hard-edge screen-print finish"]]
  }),
  buildStyle({
    ...
    visualSpec: [["极简主义设计", "Minimalist design"], ["严格模块与大量负空间", "strict modules with generous negative space"], ["基本几何体与重复单元", "primary geometric forms and repeated units"], ["黑白工业灰配单色强调", "black white industrial gray with one accent"], ["中性无衬线排版", "neutral sans-serif typography"], ["不锈钢玻璃哑光质感", "stainless steel glass and matte finish"]]
  }),
  buildStyle({
    ...
    visualSpec: [["观念艺术档案", "Conceptual art archive"], ["对象与说明并置", "juxtaposition of object and explanatory text"], ["现成物照片与编号文档", "found object photographs and numbered documents"], ["黑白办公灰", "black white and office gray"], ["打字机与标签排版", "typewriter and label typography"], ["复印纸胶带档案质感", "photocopy paper tape and archival texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["粗野主义建筑", "Brutalist architecture"], ["巨型模块堆叠构图", "monumental stacked-module composition"], ["悬挑混凝土与重复窗格", "cantilevered concrete and repetitive window bays"], ["混凝土灰炭黑锈红", "concrete gray charcoal and rust red"], ["粗体建筑标识", "bold architectural signage"], ["木模清水混凝土质感", "board-formed raw concrete texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["中世纪现代主义", "mid-century modern design"], ["开放不对称布局", "open asymmetrical layout"], ["锥形支脚与有机曲面", "tapered legs and organic shell forms"], ["芥末黄青绿砖橙", "mustard yellow teal and burnt orange"], ["友好几何无衬线", "friendly geometric sans-serif"], ["胡桃木黄铜与粗花呢", "walnut brass and tweed texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["六十年代迷幻海报", "1960s psychedelic poster"], ["满版万花筒构图", "dense kaleidoscopic composition"], ["液态曲线与变形人物", "liquid curves and warped figures"], ["荧光粉酸绿电紫", "neon pink acid green and electric violet"], ["融化式手绘字体", "melting hand-drawn lettering"], ["错位丝网与油墨叠色", "misregistered screen print and overprinted ink"]]
  }),
  buildStyle({
    ...
    visualSpec: [["后现代主义设计", "Postmodern design"], ["断裂网格与多重中心", "broken grid with multiple focal points"], ["历史符号和流行图像拼贴", "collage of historical symbols and popular imagery"], ["粉青黄与黑白纹样", "pink teal yellow and black-white patterns"], ["多字体反规则混排", "rule-breaking mixed typography"], ["彩色层压板与印刷拼贴", "colored laminate and print-collage texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["新表现主义绘画", "Neo-Expressionist painting"], ["拥挤满幅冲撞构图", "crowded confrontational all-over composition"], ["原始人物与涂写符号", "raw figures and scrawled symbols"], ["焦黑脏黄钴蓝猩红", "charred black dirty yellow cobalt and scarlet"], ["刮刻涂鸦文字", "scratched graffiti lettering"], ["厚涂炭笔与拼贴刮痕", "impasto charcoal collage and scratched texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["街头艺术壁画", "street art mural"], ["适应墙面的大尺度满幅构图", "large wall-responsive composition"], ["喷漆标签模板与角色图形", "spray tags stencils and character graphics"], ["黑白配荧光原色", "black and white with neon primaries"], ["粗体泡泡涂鸦字", "bold bubble graffiti lettering"], ["混凝土喷漆滴流剥落", "concrete spray drips and peeling texture"]]
  }),
  buildStyle({
    ...
    visualSpec: [["蒸汽波美学", "vaporwave aesthetic"], ["中心拼贴与透视网格", "central collage over perspective grid"], ["古典雕塑棕榈树旧电脑", "classical bust palm trees and retro computer"], ["粉紫青蓝日落橙", "pink violet cyan and sunset orange"], ["日文像素字混排", "Japanese and pixel typography mix"], ["VHS 噪点与低清压缩", "VHS noise and lo-fi compression"]]
  }),
  buildStyle({
    ...
    visualSpec: [["赛博朋克城市", "cyberpunk city"], ["低机位拥挤纵深", "low-angle dense urban depth"], ["霓虹招牌管线与机械义体", "neon signage cables and cybernetic bodies"], ["电青洋红酸黄深黑", "electric cyan magenta acid yellow and black"], ["多语种终端排版", "multilingual terminal typography"], ["雨水反光锈蚀与屏幕噪点", "wet reflections rust and screen noise"]]
  }),
  buildStyle({
    ...
    visualSpec: [["合成波复古未来", "synthwave retrofuturism"], ["中央地平线单点透视", "centered horizon with one-point perspective"], ["条纹落日网格与跑车", "striped sunset grid and sports car"], ["霓虹紫洋红电蓝", "neon violet magenta and electric blue"], ["镀铬斜体街机字", "chrome italic arcade lettering"], ["VHS 扫描线与数字辉光", "VHS scanlines and digital glow"]]
  }),
  buildStyle({
    ...
    visualSpec: [["Frutiger Aero 美学", "Frutiger Aero aesthetic"], ["开阔自然景观与悬浮界面", "open natural landscape with floating UI"], ["水泡叶片与玻璃按钮", "bubbles leaves and glass buttons"], ["天空蓝草绿水青", "sky blue grass green and aqua"], ["圆润人文无衬线", "rounded humanist sans-serif"], ["高光玻璃水滴与柔塑料", "glossy glass water droplets and soft plastic"]]
  }),
  buildStyle({
    ...
    visualSpec: [["扁平化数字设计", "flat digital design"], ["规则卡片网格与清晰层级", "regular card grid with clear hierarchy"], ["基础图标与几何插画", "simple icons and geometric illustration"], ["明蓝珊瑚红薄荷绿", "bright blue coral red and mint green"], ["中性无衬线界面字", "neutral sans-serif UI typography"], ["纯色面与极少阴影", "solid color surfaces with minimal shadow"]]
  }),
  buildStyle({
    ...
    visualSpec: [["Material Design 界面", "Material Design interface"], ["八点网格与分层表面", "eight-point grid with layered surfaces"], ["卡片系统与浮动操作按钮", "card system and floating action button"], ["大胆主色配中性表面", "bold primary color with neutral surfaces"], ["严格现代无衬线字阶", "strict modern sans-serif type scale"], ["纸张层级与柔和投影", "paper-like elevation and soft shadows"]]
  }),
  buildStyle({
    ...
    visualSpec: [["企业孟菲斯插画", "Corporate Memphis illustration"], ["中心人物模块化场景", "centered modular character scene"], ["夸张四肢无面孔人物", "small-headed faceless figures with exaggerated limbs"], ["珊瑚柔蓝薰衣草紫", "coral soft blue and lavender"], ["友好圆润无衬线", "friendly rounded sans-serif"], ["纯色矢量与轻微颗粒", "flat vector color with subtle grain"]]
  }),
  buildStyle({
    ...
    visualSpec: [["太阳朋克未来城市", "solarpunk future city"], ["开阔社区全景构图", "open community panorama"], ["绿植建筑太阳能与温室", "plant-covered buildings solar panels and greenhouses"], ["叶绿天空蓝阳光黄", "leaf green sky blue and sunlight yellow"], ["人文社区标识", "humanist community signage"], ["木材玻璃再生金属与植物", "wood glass recycled metal and lush vegetation"]]
  }),
  buildStyle({
    ...
    visualSpec: [["生成艺术系统", "generative art system"], ["规则驱动的递归构图", "rule-driven recursive composition"], ["粒子流场网格与分形", "particle flow fields grids and fractals"], ["算法生成的连续色阶", "algorithmically generated color scale"], ["等宽代码标签", "monospaced code labels"], ["精密矢量与发光粒子", "precise vectors and luminous particles"]]
  }),
  buildStyle({
    ...
    visualSpec: [["故障艺术", "glitch art"], ["横向数据撕裂构图", "horizontal data-tear composition"], ["像素块 RGB 错位与扫描线", "pixel blocks RGB shift and scanlines"], ["电青洋红信号绿深黑", "electric cyan magenta signal green and black"], ["损坏等宽字符", "corrupted monospaced characters"], ["JPEG 压缩与模拟噪点", "JPEG artifacts and analog static texture"]]
  })
];
